...
class TestFunctionalAssociationFormatting:
    ...
    def test_get_gene_functional_annotations_formats_groups_once(self, mock_gene_with_associations):
        ...
        assert [group["type"] for group in functional_associations["datasets"][0]["associations"]] == [
            "increased",
            "decreased",
        ]
